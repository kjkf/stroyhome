        ...
        <div class="footer__in">
            ...
            <div class="footer-ctr">
                ...
                <div class="address br-btm">
                    ...
                    <div class="address__text"><span>Санкт-Петербург, </span><span>Наб. Обводного канала, 60</span></div>
                    <div class="address__text text-bold">+7 (495) 929-70-06</div>
                </div>

                <div class="schedules br-btm">
                    <h5>Режим работы:</h5>
                    <div class="schedule">
            ...
            <div class="footer-right">
                ...
                <div class="callback-wrap">
                    <ul class="callback callback--white">
                        ...
                        <li class="callback__item inst-btn">
                            <a href="#" class="btn callback__btn">
                                <svg class="svg-wrap" viewBox="0 0 33 33" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <use class="svg-sym" xlink:href="#inst-ic" x="0" y="0"></use>
                                </svg>
                            </a>
                        </li>
                    </ul>
